...
from runtools.runcore.common import ConfigFileNotFoundError
from runtools.runcore.util.attr import get_module_attributes


class LogMode(Enum):
    """
    This enum represents different logging modes that determine the behavior of loggers within the runtools package.
    All loggers should be children of the `runtools` logger, allowing all logging generated by the package to be
    enabled, forwarded to the root logger, or disabled as needed by setting this mode in `log` module.

    Attributes:
        ENABLED:
            In this mode, the 'runtools' parent logger is enabled and configured handlers are added. As a result,
            all 'runtools' logging is standardized and is handled independently of the client's root logger.
        PROPAGATE:
        ...
        DISABLED:
            In this mode, all 'runtools' logging is disabled.
    """
