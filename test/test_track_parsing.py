...
def test_parse_event():
    ...
    parser.new_output('event=[eventim_apollo] in hammersmith')
...
def test_event_timestamps():
    ...
    assert tracker.to_status().last_event.timestamp == datetime.strptime('2020-10-01 10:30:30.543', "%Y-%m-%d %H:%M:%S.%f")
